...
export default function TeacherNotificationsPage() {
  ...
  const canFetchNotifications = !loading && user?.role === 'teacher'
  ...
  if (loading || isLoading) {
    return (
      <AppLoading
        title="Preparing teacher notifications"
        subtitle="Loading project updates, student messages, reports, and system alerts."
      />
    )
  }
      ...
      <main className="container mx-auto max-w-7xl px-4 py-8">
        <div className="page-hero slide-up">
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="page-kicker">Teacher Notifications</p>

              <h1 className="page-title">Notifications</h1>

              <p className="page-subtitle">
                Track project updates, student messages, fairness reports,
                disputes, and system notifications.
              </p>
            </div>
        ...
        <Card className="professional-card">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Showing latest notifications for your teacher account.
            </p>
          </CardHeader>
            ...
            {!notifications || notifications.length === 0 ? (
              <div className="py-12 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Updates about your projects, students, reports, and messages
                  will appear here.
                </p>
              </div>
            ) : (
